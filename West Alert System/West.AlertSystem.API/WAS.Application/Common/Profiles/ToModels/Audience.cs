...
{
    public class Audience : AutoMapper.Profile
    {
        public Audience()
        {

            CreateMap<Domain.Entities.SubscriptionGroup, Models.Audience>()
             ...
             .ForMember(
              ...
              .ForMember(
                  ...
                  opt => opt.MapFrom(src => src.Subscription.EmployeeId))
              .ForMember(
                  dest => dest.DepartmentId,
                  opt => opt.MapFrom(src => src.Subscription.Department.Id))
                .ForMember(
                  dest => dest.DepartmentName,
                  opt => opt.MapFrom(src => src.Subscription.Department.Name))
             ;


            CreateMap<Domain.Entities.SurveyBroadcastSubscription, Models.Audience>()
             .AddTransform<string>(o => string.IsNullOrWhiteSpace(o) ? null : o)
             .IgnoreAllPropertiesWithAnInaccessibleSetter()
             .ForMember(
                 dest => dest.Id,
