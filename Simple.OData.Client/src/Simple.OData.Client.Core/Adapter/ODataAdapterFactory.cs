...
namespace Simple.OData.Client.WestInternal
{
    ...
    {
        private const string AdapterV3AssemblyName = "Simple.OData.Client.WestInternal.V3.Adapter";
        private const string AdapterV4AssemblyName = "Simple.OData.Client.WestInternal.V4.Adapter";
        private const string AdapterV3TypeName = "Simple.OData.Client.WestInternal.V3.Adapter.ODataAdapter";
        private const string AdapterV4TypeName = "Simple.OData.Client.WestInternal.V4.Adapter.ODataAdapter";
        private const string ModelAdapterV3TypeName = "Simple.OData.Client.WestInternal.V3.Adapter.ODataModelAdapter";
        private const string ModelAdapterV4TypeName = "Simple.OData.Client.WestInternal.V4.Adapter.ODataModelAdapter";
