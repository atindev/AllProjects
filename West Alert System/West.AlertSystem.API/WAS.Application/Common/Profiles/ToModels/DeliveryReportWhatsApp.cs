...
{
    public class DeliveryReportWhatsApp : AutoMapper.Profile
    {
        public DeliveryReportWhatsApp()
        {
            CreateMap<Domain.Entities.DeliveryReportWhatsApp, Models.FailedNotification>()
