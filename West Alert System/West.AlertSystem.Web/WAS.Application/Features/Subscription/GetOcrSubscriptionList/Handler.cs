    ...
    public class Handler : IRequestHandler<Request, Response>
    {
        ...
        public async Task<Response> Handle(Request request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var response = await $"{_wASApiSettings.ApiBaseUrl}/{EndPointSettings.GetOcrSubscriptionList}?AdminOfficialEmail={request.AdminOfficialEmail}&LocationId={request.LocationId}"
