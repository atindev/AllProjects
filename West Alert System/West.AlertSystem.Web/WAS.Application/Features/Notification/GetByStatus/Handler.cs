    ...
    public class Handler : IRequestHandler<Request, Response>
    {
        ...
        public async Task<Response> Handle(Request request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var notifications = await $"{_wASApiSettings.ApiBaseUrl}/{EndPointSettings.GetByStatus}/{request.Status}/{request.Email}/{request.IsOnlyPrivateApprover}/{request.IsGlobalAdmin}/{request.HavingBothApprovalLevel}"
